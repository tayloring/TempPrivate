...
public class BusLineOverlay extends OverlayManager {
    ...
    public boolean onBusStationClick(int index) {
        if (mBusLineResult.getStations() != null
            ...
            TLog.i("baidumapsdk", "BusLineOverlay onBusStationClick");
        }
        return false;
    }
    ...
    public final boolean onMarkerClick(Marker marker) {
        if (mOverlayList != null && mOverlayList.contains(marker)) {
            marker.setTitle(mBusLineResult.getStations().get(mOverlayList.indexOf(marker)).getTitle());
            Bundle extraBundle = new Bundle();
            extraBundle.putString("uid", mBusLineResult.getStations().get(mOverlayList.indexOf(marker)).getUid());
            marker.setExtraInfo(extraBundle);
