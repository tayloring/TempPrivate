...
import com.whu.Gongyinchao.schoolservice.User.ui.LogOut;
...
import com.whu.Gongyinchao.schoolservice.chatmodule.slidinglayer.SlidingLayer;
import com.whu.Gongyinchao.schoolservice.chatmodule.slidinglayer.SlidingLayer.OnInteractListener;
import com.whu.Gongyinchao.schoolservice.chatmodule.switchbtn.SwitchButton;
...
import com.whu.Gongyinchao.schoolservice.chatmodule.wheel.adapters.ArrayWheelAdapter;
...
public class RightFragment extends Fragment implements OnClickListener,
	...
	private void initView(View view) {
		...
		mHead.setImageResource(SchoolServiceApplication.heads[mSpUtil.getHeadIcon()]);
	...
	private void setListener() {
		...
		//SlidingMenu slidingMenu = ( (MineAboutActivity)getActivity())
		//		.getSlidingMenu();
		// 监听菜单关闭，来关闭弹出的设置view
		/*if (slidingMenu != null)
	...
	public void onClick(View v) {
		...
		case R.id.confirm_exit_btn:
			...
			if (PushManager.isPushEnabled(getActivity())) {
				PushManager.stopWork(getActivity());//停止并退出
		...
		case R.id.feed_back_btn:
			...
			if (!TextUtils.isEmpty(content)) {
				...
				intent.putExtra(Intent.EXTRA_SUBJECT, "SchoolServiceAndroid客户端 - 信息反馈");
				intent.putExtra(Intent.EXTRA_TEXT, content);
				intent.setData(Uri.parse("woduta@foxmail.com"));
