...
public class FaceAdapter extends BaseAdapter {
	...
	public FaceAdapter(Context context, int currentPage) {
		...
		mFaceMap = SchoolServiceApplication.getInstance().getFaceMap();
		initData();
	}
	...
	@Override
	public int getCount() {
		return SchoolServiceApplication.NUM + 1;
	}
