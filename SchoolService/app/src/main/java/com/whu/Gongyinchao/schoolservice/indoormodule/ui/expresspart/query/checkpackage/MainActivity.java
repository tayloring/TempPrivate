...
import com.whu.Gongyinchao.schoolservice.indoormodule.ui.expresspart.query.cls.cls_savehistory;
...
import static com.whu.Gongyinchao.schoolservice.indoormodule.ui.expresspart.query.utils.Common.closeKeyboardCommAct;
import static com.whu.Gongyinchao.schoolservice.indoormodule.ui.expresspart.query.utils.Common.closeWhenOncreate;

import static com.whu.Gongyinchao.schoolservice.indoormodule.ui.expresspart.query.utils.Common.onlineFlag;
...
public class MainActivity extends Activity implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_mainqueryexpress);
	...
	public void initView() {
		...
		if (!onlineFlag(MainActivity.this)) {
	...
	private Handler mHandler = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			case FINISHED:
				...
				closeKeyboardCommAct(MainActivity.this);// 关闭键盘
				break;
