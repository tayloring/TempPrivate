package com.whu.Gongyinchao.schoolservice.chatmodule.slidinglayer;
...
public class SlidingLayer extends FrameLayout {
	...
	public SlidingLayer(Context context, AttributeSet attrs, int defStyle) {
		...
		// Set the side of the screen 从哪一个方向隐藏和显示菜单
		// setStickTo(ta.getInt(R.styleable.SlidingLayer_stickTo,
		// STICK_TO_AUTO));
