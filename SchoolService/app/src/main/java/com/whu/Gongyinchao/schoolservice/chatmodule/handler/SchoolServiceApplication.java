package com.whu.Gongyinchao.schoolservice.chatmodule.handler;

//@TargetApi(Build.VERSION_CODES.HONEYCOMB)
/*public class SchoolServiceApplication extends Application {
	public final static String API_KEY = "g1dONKHjT05kX9wrVIyzGM4c";
	public final static String SECRIT_KEY = "co0BI06E3SaM1KtTS64grNwSVHh8nFn7";
	...
	public synchronized static SchoolServiceApplication getInstance() {
		return mApplication;
	}
