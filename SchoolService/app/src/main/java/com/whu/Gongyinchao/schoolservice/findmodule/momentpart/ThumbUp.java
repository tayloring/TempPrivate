 ...
 */
public class ThumbUp extends Service{
    @Nullable
    @Override
    ...
    private void  thumb(final String op){

        final String momentid="";//id of a moment
        ...
        String httpurl = "http://115.159.74.116:8000/moment/thumb_up/";
