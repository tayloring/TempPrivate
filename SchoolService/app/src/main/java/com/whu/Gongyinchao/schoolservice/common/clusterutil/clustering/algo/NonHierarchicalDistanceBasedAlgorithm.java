...
package com.whu.Gongyinchao.schoolservice.common.clusterutil.clustering.algo;
...
import com.whu.Gongyinchao.schoolservice.common.clusterutil.projection.Bounds;
...
import com.whu.Gongyinchao.schoolservice.common.clusterutil.quadtree.PointQuadTree;
...
public class NonHierarchicalDistanceBasedAlgorithm<T extends ClusterItem> implements Algorithm<T> {
    ...
    public Set<? extends Cluster<T>> getClusters(double zoom) {
        ...
        final Map<QuadItem<T>, com.whu.Gongyinchao.schoolservice.common.clusterutil.clustering.algo.StaticCluster<T>> itemToCluster =
                new HashMap<QuadItem<T>, com.whu.Gongyinchao.schoolservice.common.clusterutil.clustering.algo.StaticCluster<T>>();
        ...
        synchronized (mQuadTree) {
            for (QuadItem<T> candidate : mItems) {
                ...
                com.whu.Gongyinchao.schoolservice.common.clusterutil.clustering.algo.StaticCluster<T> cluster =
                        new com.whu.Gongyinchao.schoolservice.common.clusterutil.clustering.algo
