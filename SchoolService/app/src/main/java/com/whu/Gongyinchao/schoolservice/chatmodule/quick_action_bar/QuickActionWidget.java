 ...
 */
package com.whu.Gongyinchao.schoolservice.chatmodule.quick_action_bar;
...
public abstract class QuickActionWidget extends PopupWindow {
	...
	private void prepareAnimationStyle() {
		...
		if (arrowPointX <= screenWidth / 4) {
			...
			setAnimationStyle(onTop ? R.style.popup_right
					: R.style.popdown_right);
		} else {
			setAnimationStyle(onTop ? R.style.popup_center
					: R.style.popdown_center);
		}
	}
